...
<div <?php echo trim($attr_row); ?>>
    ...
    <?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
        <div class="item">
			...
			<?php wc_get_template( 'item-product/skins/'.$skin.'/'. $product_style .'.php', array('flash_sales' => $flash_sales, 'end_date' => $end_date, 'countdown_title' => $countdown_title, 'countdown' => $countdown, 'product_style' => $product_style, 'size_image' => $size_image ) ); ?>
			</div>
        </div>
