...
class Tbay_PostType_Megamenu {
  	...
  	public static function register_post_type() {
	    $labels = array(
			'name'                  => __( 'مگامنو ساز', 'tbay-elementor' ),
			'singular_name'         => __( 'مگامنو', 'tbay-elementor' ),
			'add_new'               => __( 'افزودن مگامنو جدید', 'tbay-elementor' ),
			'add_new_item'          => __( 'افزودن مگامنو جدید', 'tbay-elementor' ),
			'edit_item'             => __( 'ویرایش مگامنو', 'tbay-elementor' ),
			'new_item'              => __( 'مگامنو جدید', 'tbay-elementor' ),
			'all_items'             => __( 'مگامنو ساز', 'tbay-elementor' ),
			'view_item'             => __( 'نمایش مگامنو', 'tbay-elementor' ),
			'search_items'          => __( 'جستجو مگامنو', 'tbay-elementor' ),
			'not_found'             => __( 'مگامنوی یافت نشد', 'tbay-elementor' ),
			'not_found_in_trash'    => __( 'مگاموی در زباله دان یافت نشد', 'tbay-elementor' ),
			'parent_item_colon'     => '',
			'menu_name'             => __( 'مگامنو ساز', 'tbay-elementor' ),
	    );
