...
class Tbay_PostType_Customtab {
  	...
  	public static function register_post_type() {
	    $labels = array(
			'name'                  => __( 'سفارش سازی تب های محصول', 'tbay-elementor' ),
			'singular_name'         => __( 'سفارش سازی تب', 'tbay-elementor' ),
			'add_new'               => __( 'افزودن سفارش سازی تب جدید', 'tbay-elementor' ),
			'add_new_item'          => __( 'افزودن سفارش سازی تب جدید', 'tbay-elementor' ),
			'edit_item'             => __( 'ویرایش سفارش سازی تب', 'tbay-elementor' ),
			'new_item'              => __( 'سفارش سازی تب جدید', 'tbay-elementor' ),
			'all_items'             => __( 'سفارش سازی تب های محصول', 'tbay-elementor' ),
			'view_item'             => __( 'نمایش سفارش سازی تب', 'tbay-elementor' ),
			'search_items'          => __( 'جستجو سفارش سازی تب', 'tbay-elementor' ),
			'not_found'             => __( 'سفارش سازی تب یافت نشد', 'tbay-elementor' ),
			'not_found_in_trash'    => __( 'سفارش سازی تب در زباله دان یافت نشد', 'tbay-elementor' ),
			'parent_item_colon'     => '',
			'menu_name'             => __( 'سفارش سازی تب های محصول', 'tbay-elementor' ),
	    );
