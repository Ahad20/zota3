...
if ( ! class_exists( 'YITH_WCWL_Frontend' ) ) {
	...
	class YITH_WCWL_Frontend {
			...
			return apply_filters(
				...
				array(
					...
					'labels' => array(
						...
						'added_to_cart_message' => sprintf( '<div class="woocommerce-notices-wrapper"><div class="woocommerce-message" role="alert">%s</div></div>', apply_filters( 'yith_wcwl_added_to_cart_message', __( 'محصول با موفقیت به سبد خرید اضافه شد', 'yith-woocommerce-wishlist' ) ) ),
					),
					'actions' => array(
		...
		public function alter_add_to_cart_args( $args ) {
			...
			$pos = array_search( 'button', $classes );
